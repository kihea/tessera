...
import type { CheckCard, FeedCard, FormulaCard, PassageCard, Thread } from '../types';
    ...
    <article className={`card checkpoint-card ${done ? 'cleared' : ''}`}>
      ...
      <div className="quote-pair">
        <figure className="quote-block">
          <blockquote className="excerpt mini serif">{plainExcerpt(card.quoteA.text)}</blockquote>
          <figcaption className="quote-cite">
            card {card.cardRefA} · {card.quoteA.title}
          </figcaption>
        </figure>
        ...
        <figure className="quote-block">
          <blockquote className="excerpt mini serif">{plainExcerpt(card.quoteB.text)}</blockquote>
          <figcaption className="quote-cite">
            card {card.cardRefB} · {card.quoteB.title}
          </figcaption>
        </figure>
      </div>
      {done ? (
