          ...
          <>
            ...
            <section className="settings-field">
              ...
              <label className="settings-check">
                <input
                  type="checkbox"
                  checked={dev.graphProvider === true}
                  onChange={(e) => setDev({ ...dev, graphProvider: e.target.checked })}
                />
                <span>
                  Pull your knowledge graph in as a source alongside the live providers (off by
                  default — only your verbatim material on the exact topic, never drifts)
                </span>
              </label>
              <label className="settings-check">
                <input
              ...
              <label className="settings-check">
                <input
                  type="checkbox"
                  checked={dev.iceberg === true}
                  onChange={(e) => setDev({ ...dev, iceberg: e.target.checked })}
                />
                <span>
                  Iceberg ordering — open each session on the big picture (high-dimensional concepts
                  &amp; forms over time), then dial into attributes and idea-forms
                </span>
              </label>
            </section>
